...
onload = function(){
	...
	uniLocation[6] = gl.getUniformLocation(prg, 'useTexture');
	uniLocation[7] = gl.getUniformLocation(prg, 'time');
	uniLocation[8] = gl.getUniformLocation(prg, 'resolution');
	...
	(function(){
		...
		gl.uniform1f(uniLocation[7], time);
		gl.uniform2fv(uniLocation[8], [fBufferWidth,fBufferHeight]);
